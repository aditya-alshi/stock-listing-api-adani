...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  let sortedStocks = stocksCopy.sort((stock1, stock2) => sortStocksByPricing(stock1, stock2, pricing))
  res.json({ stocks: sortedStocks })
});

// Function to sort stocks by growth rate
function sortStocksByGrowthRate(stock1, stock2, growth){
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  let sortedStocks = stocksCopy.sort((stock1, stock2) => sortStocksByGrowthRate(stock1, stock2, growth));
   res.json({ stocks: sortedStocks });
});

// Function to sort stocks by name alphabetically
function sortStocksByNameAlphabetically(stock1, stock2, name){
  if(name === "z-a"){
...
app.get('/stocks/sort/name', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  let sortedStocks = stocksCopy.sort((stock1, stock2) => sortStocksByNameAlphabetically(stock1, stock2, name));
  res.json({ stocks: sortedStocks })
})

// Function that returns the stocks of the selected exchange.
...
// Function that returns the stocks if it meets the selected industry criteria
